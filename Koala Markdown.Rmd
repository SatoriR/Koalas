...
koala <- koala %>% 
  mutate_if(is.character, str_to_lower) %>% # Change all character columns to be lower cased
  mutate_if(is.character, str_trim)

koala <- tidyr::separate(koala,
                         Call.Date,
                         c('month', 'day', 'year'), sep = "/", remove = FALSE)
...
None of the 38 variables are defined. However, some of them are easy to interpret like Fall, Sick or Injured. Many of the variables are not such as Wasted or Animal Name. In addition to this, the data is messy with 745 Animal.Record.No's being duplicates.These were removed for continuity.
